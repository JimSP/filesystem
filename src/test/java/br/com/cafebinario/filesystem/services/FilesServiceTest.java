...
public class FilesServiceTest {
    ...
    public void testUpdateOperations() {
    	...
    	assertEquals(300, filesService.update(UpdateDTO
    			.builder()
    			.path("/")
    	...
    	assertEquals(0, filesService.update(UpdateDTO
    			.builder()
    			.path("/test99.txt")
    			.updatableEntrys(Arrays.asList(updatableEntryDTO))
    			.build())
    	...
    	assertEquals(3, filesService.update(UpdateDTO
    			.builder()
    			.path("/test99.txt")
