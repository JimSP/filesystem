package br.com.cafebinario.filesystem.ftp;
...
public final class FtpFileCreator {

	public static FtpFile create(final Path source, final FileSystem fileSystem, final PathToFtpFileMapper pathToFtpFileMapper) {
		...
		return new FtpFile() {
            ...
            public List<? extends FtpFile> listFiles() {
                ...
                try (final Stream<Path> stream = Files.list(getPath())) {
                    ...
                    return stream
                            .map(pathToFtpFileMapper::convert)
